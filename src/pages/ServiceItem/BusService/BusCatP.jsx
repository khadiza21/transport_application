            ...
            <div className="hero py-8 my-24 ">
                <div className="hero-content flex-col lg:flex-row">
                    <div className="text-center lg:text-left pr-14">
                        ...
                        <Link className="font-semibold uppercase border-orange-400" to='/publicbus'> <button  className="btn btn-outline border-0 bg-slate-200  border-b-4 mt-4 ">  Take Service </button></Link>
                    </div>
