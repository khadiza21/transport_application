    ...
    return (
        <>
            ...
            <div className="mx-auto px-4 container">
                <div className="card flex flex-col lg:flex-row w-full rounded-lg">
                    <div className='rounded-lg w-full lg:w-4/12 h-auto lg:h-[80vh]'>
                        <section className='rounded-lg p-5'>
                            <MapContainer center={position} zoom={7} style={{ height: '500px', width: '100%' }} className='lg:h-[500px]'>
                                <TileLayer
                        ...
                        <section className='px-8 py-4  shadow-lg '>
                            <h1 className="text-xl lg:text-3xl font-semibold text-center mb-6">Request a ride for now or later</h1>
