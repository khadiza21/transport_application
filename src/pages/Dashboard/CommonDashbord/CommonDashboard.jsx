...
const CommonDashboard = () => {
    ...
    return (
        <div>
            ...
            {userData && (userData?.role === 'user') ? <div>
                ...
                <>
                    ...
                    <section className='mx-44 px-5 py-5 mb-24 mt-5'>
                        <div className="join join-vertical w-full shadow-xl bg-slate-100">
                            <div className="collapse collapse-arrow join-item border border-slate-300 p-2">
                                <input type="radio" name="my-accordion-4" defaultChecked />
                                <div className="collapse-title text-xl font-medium font-bold text-slate-900">
                                  Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                                </div>
                                <div className="collapse-content text-gray-500">
                                    <p>hello Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni sapiente distinctio reprehenderit explicabo inventore, veniam culpa totam laboriosam est placeat.</p>
                                </div>
                            </div>
                            <div className="collapse collapse-arrow join-item border border-slate-300 p-2">
                    ...
                    <div>
                        <footer className="footer items-center p-4 bg-neutral text-neutral-content  px-44  bottom-0 w-full text-center">
